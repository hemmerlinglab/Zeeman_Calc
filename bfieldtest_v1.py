...
#plt.plot(ys/10,BY1[:,2]*10,color='r',linestyle='--')
#plt.plot(ys/10,BY2[:,2]*10,color='r',linestyle='--')
#plt.plot(ys/10,BY3[:,2]*10,color='r',linestyle='--')
#plt.plot(ys/10,BY4[:,2]*10,color='r',linestyle='--')
#plt.plot(ys/10,BY5[:,2]*10,color='r',linestyle='--')
#plt.plot(ys/10,BY6[:,2]*10,color='r',linestyle='--')
#plt.plot(ys/10,BY7[:,2]*10,color='r',linestyle='--')
#plt.plot(ys/10,BY8[:,2]*10,color='r',linestyle='--')
h = .2
